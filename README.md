...
3. Install a few required pip packages, which are specified in the requirements text file. Be sure to run the command from the project root directory since the requirements.txt file is there.
...
- [Patient Selection for Diabetes Drug Testing](https://github.com/TRoboto/Udacity/tree/master/AI%20for%20Healthcare%20Nanodegree/Project%20-%20Patient%20Selection%20for%20Diabetes%20Drug%20Testing)
